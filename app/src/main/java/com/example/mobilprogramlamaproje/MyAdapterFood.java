...
public class MyAdapterFood extends RecyclerView.Adapter<MyAdapterFood.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MyAdapterFood.MyViewHolder(LayoutInflater.from(context).inflate(R.layout.foodrowitem,parent,false),delegate);
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        int img=ymk.getImage();

        holder.text.setText(name);
        holder.textkalori.setText(kalori);
        holder.imgg.setImageResource(img);
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView, ClickDelegate delegate ) {
            ...
            imgg=itemView.findViewById(R.id.imageView);
